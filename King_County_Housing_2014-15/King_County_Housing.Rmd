...
train_set_glm <- housing_data_sample_reg[, !(colnames(housing_data_sample_reg) %in% c("price", "yr_built", "yr_renovated", "lat", "long", "zipcode"))]
train_price <- housing_data_sample_reg[, "price"]
