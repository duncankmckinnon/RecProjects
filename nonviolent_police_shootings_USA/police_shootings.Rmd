...
There is no question that police shootings of non-violent civilians are rare events.  This map shows the number of civilians killed in major cities across the US. According to this dataset, the chances of being killed in any non-violent encounter with police for a civilian are around 1/100141.
```{r}
