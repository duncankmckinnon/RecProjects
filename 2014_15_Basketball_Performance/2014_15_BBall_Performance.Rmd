...
#Plotly Graphic
#embed_notebook(players_stats_plot_plotly)
```
...
#Plotly Graphic
#embed_notebook(avg_position_ranks_plotly)
```
...
#Plotly Graphic
#embed_notebook(player_position_ranks_plotly)
...
#plotly Graphic
#embed_notebook(position_ranks_dist_plotly)
